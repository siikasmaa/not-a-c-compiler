...
class Parser():
    ...
    def __call__(self):
        current_token = self._lexer.get_next_token()
        ...
        while len(self._stack) > 0:
            ...
            self._log(current_grammar_string, current_input)

            if current_grammar_string == GrammarString.EPSILON:
                self._pop_stack()
                self._add_parse_tree_node(
                    current_grammar_string.value, current_node)
            elif isinstance(current_grammar_string, ActionSymbol):
                self._pop_stack()
                self._analyzer.code_gen(current_grammar_string, current_input)
            # Match!
                ...
                if current_input in parse_action:
                    ...
                    self._write_syntax_error(current_token.get_row(
                    ), 'missing %s' % current_grammar_string.value)
                    continue
                ...
                self._write_syntax_error(
                    current_token.get_row(), error_message)
                break

        if current_token.get_type() == TokenType.EOF:
            self._add_parse_tree_node(
    ...
    # In case of TYPE_SPECIFIER -> add info to symboltable
    ...
    grammar = {
        ...
        GrammarString.DECLARATION_INITIAL: {
            'void': [GrammarString.TYPE_SPECIFIER, ActionSymbol.PROCESS_ID, TokenType.ID, ActionSymbol.ASSIGN_EMPTY], 'int': [GrammarString.TYPE_SPECIFIER, ActionSymbol.PROCESS_ID, TokenType.ID]
        },
        ...
        GrammarString.VAR_DECLARATION_PRIME: {
            ';': [ActionSymbol.ASSIGN_EMPTY, ';'], '[': ['[', ActionSymbol.PROCESS_ARRAY, TokenType.NUM, ']', ';']
        },
        ...
        GrammarString.PARAMS: {
            'void': [TokenType.KEYWORD, GrammarString.PARAM_LIST_VOID_ABTAR], 'int': [TokenType.KEYWORD, ActionSymbol.PROCESS_ID, TokenType.ID, GrammarString.PARAM_PRIME, GrammarString.PARAM_LIST]
        },
        ...
        GrammarString.STATEMENT_LIST: {
            ...
            '-': [GrammarString.STATEMENT, GrammarString.STATEMENT_LIST], 'output': [GrammarString.STATEMENT, GrammarString.STATEMENT_LIST], '(': [GrammarString.STATEMENT, GrammarString.STATEMENT_LIST], TokenType.NUM: [GrammarString.STATEMENT, GrammarString.STATEMENT_LIST],
            '': [GrammarString.EPSILON]
        },
        GrammarString.STATEMENT: {
            ...
            'switch': [GrammarString.SWITCH_STMT], 'output': ['output', '(', GrammarString.EXPRESSION, ')', ActionSymbol.PRINT, ';'], TokenType.ID: [GrammarString.EXPRESSION_STMT], '+': [GrammarString.EXPRESSION_STMT],
        ...
        GrammarString.EXPRESSION_STMT: {
            'break': ['break', ';'], ';': [';'], TokenType.ID: [GrammarString.EXPRESSION, ActionSymbol.ASSIGN, ';'],
            '+': [GrammarString.EXPRESSION, ActionSymbol.ASSIGN, ';'], '-': [GrammarString.EXPRESSION, ActionSymbol.ASSIGN, ';'], '(': [GrammarString.EXPRESSION, ';'],
            TokenType.NUM: [GrammarString.EXPRESSION, ActionSymbol.ASSIGN, ';']
        },
        GrammarString.SELECTION_STMT: {
            'if': ['if', '(', GrammarString.EXPRESSION, ')', ActionSymbol.SAVE, GrammarString.STATEMENT, 'else', ActionSymbol.JPF_SAVE, GrammarString.STATEMENT, ActionSymbol.JUMP]
        },
        GrammarString.ITERATION_STMT: {
            'while': ['while', ActionSymbol.LABEL, '(', GrammarString.EXPRESSION, ')', ActionSymbol.SAVE, GrammarString.STATEMENT, ActionSymbol.WHILE]
        },
        ...
        GrammarString.EXPRESSION: {
            TokenType.ID: [ActionSymbol.PROCESS_ID, TokenType.ID, GrammarString.B], '+': [GrammarString.SIMPLE_EXPRESSION_ZEGOND], '-': [GrammarString.SIMPLE_EXPRESSION_ZEGOND],
        ...
        GrammarString.D: {
            '+': [GrammarString.ADDOP, GrammarString.TERM, ActionSymbol.ADDITION, GrammarString.D], '-': [GrammarString.ADDOP, GrammarString.TERM, ActionSymbol.SUBTRACT, GrammarString.D], '': [GrammarString.EPSILON]
        },
        ...
        GrammarString.C: {
            '<': [GrammarString.RELOP, GrammarString.ADDITIVE_EXPRESSION, ActionSymbol.LESS_THAN], '==': [GrammarString.RELOP, GrammarString.ADDITIVE_EXPRESSION, ActionSymbol.EQUALS], '': [GrammarString.EPSILON]
        },
        GrammarString.G: {
            '*': ['*', GrammarString.SIGNED_FACTOR, ActionSymbol.MULTIPLY, GrammarString.G], '': [GrammarString.EPSILON]
        },
        GrammarString.RELOP: {
            '<': ['<'], '==': ['==']
        },
        ...
        GrammarString.FACTOR: {
            '(': ['(', GrammarString.EXPRESSION, ')'], TokenType.ID: [ActionSymbol.PROCESS_ID, TokenType.ID, GrammarString.VAR_CALL_PRIME], TokenType.NUM: [ActionSymbol.PROCESS_NUM, TokenType.NUM]
        },
        ...
        GrammarString.FACTOR_ZEGOND: {
            '(': ['(', GrammarString.EXPRESSION, ')'],  TokenType.NUM: [ActionSymbol.PROCESS_NUM, TokenType.NUM]
        },
        GrammarString.ARGS: {
